...
export const pixelSort: FilterFunction = ({ imageCanvas, layer, selectionArea, refresh, variative }) => {
  ...
  const intensity = variative ? getRandomOffset(selection.config.intensity, 10) : selection.config.intensity
